...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 p-4 max-w-screen-2xl mx-auto">
        ...
        <section className="no-print lg:col-span-3 bg-white border border-stone-200 rounded-lg p-5 space-y-5 self-start">
          ...
          <div className="border-t border-stone-200 pt-4">
            ...
            <label className="block w-full p-3 border-2 border-dashed border-stone-300 rounded text-center cursor-pointer hover:border-stone-500 hover:bg-stone-50 transition">
              <ImageIcon size={20} className="mx-auto mb-1 text-stone-400" />
              <span className="text-xs text-stone-600 block">
                {scanUrl ? 'Scan ersetzen' : 'Verordnungs-Scan hochladen'}
              </span>
              <span className="text-[10px] text-stone-400">PNG / JPG · A5</span>
              <input
                type="file"
                accept="image/*"
                onChange={uploadScan}
      ...
      {/* HILFE / FOOTER */}
      <footer className="no-print max-w-screen-2xl mx-auto p-4 mb-6">
        <details className="bg-white border border-stone-200 rounded-lg group">
          <summary className="cursor-pointer px-5 py-3 text-sm font-medium hover:bg-stone-50 list-none flex items-center justify-between">
            <span className="flex items-center gap-2">
              <Info size={16} className="text-stone-500" />
              Anleitung & Druckhinweise
            </span>
            <span className="text-stone-400 text-xs group-open:rotate-180 transition">▾</span>
          </summary>
          <div className="px-5 pb-5 pt-2 text-sm text-stone-700 space-y-4">
            <div>
              <h4 className="font-semibold text-stone-900 mb-2">Workflow</h4>
              <ol className="list-decimal pl-5 space-y-1.5">
                <li>
                  <strong>Erstkalibrierung (einmalig pro Drucker):</strong> Eine leere
                  Verordnungsrückseite scannen (300 dpi, A5) und hochladen. Per Slider
                  oder Pfeiltasten die Zeilen exakt auf die vorgedruckten Linien
                  schieben. Profil als JSON speichern.
                </li>
                <li>
                  <strong>Im Alltag:</strong> Profil laden → Verordnungsart, Maßnahme
                  und Anzahl wählen → Originale Verordnung in den Drucker (Rückseite
                  oben) → "Drucken" klicken.
                </li>
                <li>
                  <strong>Mehrere Drucker:</strong> Pro Drucker ein eigenes Profil
                  speichern (z.B. <code className="font-mono text-xs bg-stone-100 px-1 rounded">brother.json</code>,{' '}
                  <code className="font-mono text-xs bg-stone-100 px-1 rounded">hp.json</code>).
                </li>
              </ol>
            </div>

            <div className="bg-amber-50 border-l-4 border-amber-400 px-3 py-2.5 rounded">
              <strong className="block mb-1 text-amber-900">
                Wichtige Druck-Einstellungen im Browser-Dialog:
              </strong>
              <ul className="list-disc pl-5 space-y-0.5 text-amber-900">
                <li>Format: <strong>A5 (Hochformat)</strong></li>
                <li>Skalierung: <strong>100% / Tatsächliche Größe</strong> – nicht "An Seite anpassen"</li>
                <li>Ränder: <strong>Keine</strong></li>
                <li>Hintergrundgrafiken: <strong>aus</strong></li>
                <li>Kopf-/Fußzeilen: <strong>aus</strong></li>
              </ul>
            </div>

            <div className="bg-stone-50 border-l-4 border-stone-400 px-3 py-2.5 rounded">
              <strong className="block mb-1">Tastatur-Shortcuts:</strong>
              <ul className="list-disc pl-5 space-y-0.5 text-stone-700">
                <li><code className="font-mono">↑ ↓ ← →</code> · 0,5 mm Schritte</li>
                <li><code className="font-mono">Shift + Pfeil</code> · 5 mm (grob)</li>
                <li><code className="font-mono">Alt + Pfeil</code> · 0,1 mm (Feinjustage)</li>
              </ul>
            </div>

            <div>
              <h4 className="font-semibold text-stone-900 mb-1">Tipp zur ersten Kalibrierung</h4>
              <p className="text-stone-700">
                Erst <strong>X-Offset</strong> und <strong>Y-Offset (1. Zeile)</strong> grob
                einstellen, sodass die erste Zeile sitzt. Dann <strong>Zeilenabstand</strong>{' '}
                in 0,1-mm-Schritten anpassen, bis auch die letzte Zeile (Nr. 20) genau
                auf der Linie liegt. Mit eingeblendetem Hilfsraster geht das visuell sehr schnell.
              </p>
            </div>
          </div>
        </details>
